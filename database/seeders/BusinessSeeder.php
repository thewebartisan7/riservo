...
class BusinessSeeder extends Seeder
{
    ...
    private function createBookings(Business $business, array $providers, array $services, array $customers): void
    {
        ...
        Booking::create([
            ...
            'buffer_before_minutes' => $services['taglioUomo']->buffer_before ?? 0,
            'buffer_after_minutes' => $services['taglioUomo']->buffer_after ?? 0,
        ...
        Booking::create([
            ...
            'buffer_before_minutes' => $services['colore']->buffer_before ?? 0,
            'buffer_after_minutes' => $services['colore']->buffer_after ?? 0,
            'status' => BookingStatus::Confirmed,
        ...
        Booking::create([
            ...
            'buffer_before_minutes' => $services['piega']->buffer_before ?? 0,
            'buffer_after_minutes' => $services['piega']->buffer_after ?? 0,
        ...
        Booking::create([
            ...
            'buffer_before_minutes' => $services['consulenza']->buffer_before ?? 0,
            'buffer_after_minutes' => $services['consulenza']->buffer_after ?? 0,
            'status' => BookingStatus::Pending,
            'cancellation_token' => Str::uuid()->toString(),
        ]);
        ...
        Booking::create([
            ...
            'buffer_before_minutes' => $services['taglioDonna']->buffer_before ?? 0,
            'buffer_after_minutes' => $services['taglioDonna']->buffer_after ?? 0,
